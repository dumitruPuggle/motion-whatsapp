        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 6 }}>
          ...
          <div
            style={{
              ...
              transform: `translateY(${interpolate(
                spring({
                  frame: frame - (HEADER_ENTER_DELAY + 6),
                  fps,
              ...
              opacity: interpolate(frame - (HEADER_ENTER_DELAY + 6), [0, 10], [0, 1], {
                extrapolateLeft: "clamp",
                extrapolateRight: "clamp",
              }),
            }}
          >
            {[0, 1, 2].map((k) => {
              const t = (frame / fps) * 6;
              const phase = t - k * 0.6;
              const y = interpolate(Math.sin(phase), [-1, 1], [2.5, -2.5], {
                extrapolateLeft: "clamp",
                extrapolateRight: "clamp",
              });
              const a = interpolate(Math.sin(phase), [-1, 1], [0.45, 0.95], {
                extrapolateLeft: "clamp",
                extrapolateRight: "clamp",
              });
              return (
                <div
                  ...
                  style={{
                    ...
                    height: 6,
                    borderRadius: 999,
                    backgroundColor: "rgba(233,237,239,0.85)",
            ...
            <div style={{ color: "rgba(233,237,239,0.65)", fontSize: Math.max(11, Math.round(width * 0.013)), fontWeight: 600, marginLeft: 4 }}>
              typing…
            </div>
          </div>
